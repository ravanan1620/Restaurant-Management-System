...
("kanyakumari", "mutton_Biryani, fish curry,muton chukka", 450),
("chennai", "chicken_Biryani, Pongal, Idly", 600),
("karaikudi", "mutton_Biryani, chettinad spcial,uppukari",650),
...
create table BOOKING(
    ...
    insert into Booking(Table_Num,Date,Time,Cust_Id)values
    (02,"15-05-2025","10.00 am",2),
    (12,"20-05-2025","12.00 am",1),
	(06,"11-05-2025","09.00 am",4),
	(08,"16-05-2025","09.20 am",3),
	(03,"17-05-2025","10.00 am",5),
    (10,"19-05-2025","12.00 am",7),
	(04,"20-05-2025","02.00 pm",8),
	(05,"25-05-2025","08.20 am",6);
    select*from Booking;
    
    # BETWEEN Operator
    select*from Booking where Date between "15-05-2025" AND "20-05-2025";

	# join
    select e.Booking_Id,e.Table_Num,e.Date,e.Time,e.Cust_Id,c.Customer_name
...
# Equality Operator (=)
SELECT * FROM Booking WHERE Date ="20-05-2025";
...
SELECT * FROM MENU WHERE Pric >= 150;

# Less Than or Equal To Operator (<=)
SELECT * FROM MENU WHERE Pric <= 100;
